...
def production(request):
    ...
    keywords = 'пневматическая шлифовальная машина, пневмошлифмашина цанговая, шлифмашина прямая цанговая пневматическая, торцевая пневмошлифмашина, зачистная угловая машина, пневмотрамбовка, пневматическая трамбовка, трамбовка пневматическая для уплотнения грунта, трамбовка виброзащищенная, рубильный молоток пневматический, пневмозубило, пневмопривод, пневмомотор, ремонт пневмоинструмента, собственное производство, Катран-Пневмо, Санкт-Петербург'
    description = 'Пневматический инструмент собственного производства «Катран-Пневмо»: цанговые пневмошлифмашины МП-006, МП-011, МП-011У, МП-011Р, торцевая МПС-2215 и зачистная угловая МПС-2107Щ, виброзащищенные пневмотрамбовки ТП-28А, ТПВ-3А, рубильные молотки серии РМ, пневмоприводы ПВМ-12, ППФ-420. Патенты, стендовые испытания, гарантия 12 месяцев, доставка по РФ и СНГ.'
    context = {
        'mp006': mp006,
        'mp01122': mp01122,
        'mp011u': mp011u,
